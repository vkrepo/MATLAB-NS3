...
static char methodNames[TOTAL_METHODS][CMD_BUFFER_SIZE] = {"new", "SetType", "Default", "delete"};
...
void mexFunction(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
    ...
    switch(identifyMethod(cmd))
    {
        ...
        case SETTYPE:
        {
            ...
            (reinterpret_cast<NqosWaveMacHelper*>(obj))->SetType(arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15, arg16, arg17, arg18, arg19, arg20, arg21, arg22, arg23, arg24);
            break;
        }
        case DELETE:
        {
            ...
            if (obj)
            {
                if (obj->objType == NQOSWAVEMACHELPOBJ)
                    delete reinterpret_cast<NqosWaveMacHelper*>(obj->vptr);
        ...
        case DEFAULT:
        {
            ...
            NqosWaveMacHelper *tmp = new NqosWaveMacHelper(NqosWaveMacHelper::Default());
            MemMngmt *tst = bindMngrNewElem();
