...
void mexFunction(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
    ...
    switch(identifyMethod(cmd))
    {
        ...
        case SETCHANNEL:
        {
            ...
            switch(nrhs)
            {
                case 3:
                {
                    ...
                    Ptr<ns3::YansWifiChannel> arg2 = *(reinterpret_cast<Ptr<ns3::YansWifiChannel>*>(tst2->vptr));
                    void *obj =  getElem(bindMngrHasListElem ((MemMngmt *)(*((uint64_t *)mxGetData(prhs[1])))));
                    (reinterpret_cast<YansWifiPhyHelper*>(obj))->SetChannel(arg2);
                    break;
                }
            }
            break;
        ...
        case DELETE:
        {
            ...
            if (obj)
            {
                if (obj->objType == YANSWIFIPHYHELPOBJ)
                    delete reinterpret_cast<YansWifiPhyHelper*>(obj->vptr);
        ...
        case DEFAULT:
        {
            ...
            YansWifiPhyHelper *tmp = new YansWifiPhyHelper(YansWifiPhyHelper::Default());
            MemMngmt *tst = bindMngrNewElem();
