...
static char methodNames[TOTAL_METHODS][CMD_BUFFER_SIZE] = {"new", "CreatePhys", "SetChannelScheduler", "Install", "AssignStreams", "SetRemoteStationManager", "Default", "EnableLogComponents", "delete"};
...
void mexFunction(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
    ...
    switch(identifyMethod(cmd))
    {
        ...
        case CREATEPHYS:
        {
            ...
            (reinterpret_cast<WaveHelper*>(obj))->CreatePhys(arg2);
            break;
        }
        case SETCHANNELSCHEDULER:
        {
            if ((nlhs != 0) || (nrhs > 19))
            {
                mexErrMsgTxt("enter correct number of input and output args");
            ...
            void *obj =  getElem(bindMngrHasListElem ((MemMngmt *)(*((uint64_t *)mxGetData(prhs[1])))));
            (reinterpret_cast<WaveHelper*>(obj))->SetChannelScheduler(arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15, arg16, arg17, arg18);
            break;
        }
        case INSTALL:
        {
            ...
            switch(nrhs)
            {
                case 5:
                {
                    ...
                    void *obj =  getElem(bindMngrHasListElem ((MemMngmt *)(*((uint64_t *)mxGetData(prhs[1])))));
                    NetDeviceContainer *tmp = new NetDeviceContainer((reinterpret_cast<WaveHelper*>(obj))->Install(arg2, arg3, arg4));
                    MemMngmt *tst = bindMngrNewElem();
        ...
        case ASSIGNSTREAMS:
        {
            ...
            void *obj =  getElem(bindMngrHasListElem ((MemMngmt *)(*((uint64_t *)mxGetData(prhs[1])))));
            int64_t output = (reinterpret_cast<WaveHelper*>(obj))->AssignStreams(arg2, arg3);
        ...
        case SETREMOTESTATIONMANAGER:
        {
            ...
            AttributeValue const & arg18 = *(reinterpret_cast<AttributeValue*>(tst18->vptr));
            void *obj =  getElem(bindMngrHasListElem ((MemMngmt *)(*((uint64_t *)mxGetData(prhs[1])))));
            (reinterpret_cast<WaveHelper*>(obj))->SetRemoteStationManager(arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15, arg16, arg17, arg18);
            break;
        }
        case DELETE:
        {
            ...
            if (obj)
            {
                if (obj->objType == WAVEHELPOBJ)
                    delete reinterpret_cast<WaveHelper*>(obj->vptr);
        ...
        case DEFAULT:
        {
            ...
            WaveHelper *tmp = new WaveHelper(WaveHelper::Default());
            MemMngmt *tst = bindMngrNewElem();
            tst->vptr = reinterpret_cast<void*>(tmp);
            tst->objType = WAVEHELPOBJ;
            plhs[0] = mxCreateNumericMatrix(1, 1, mxUINT64_CLASS, mxREAL);
