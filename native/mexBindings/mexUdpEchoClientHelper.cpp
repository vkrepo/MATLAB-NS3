...
void mexFunction(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
    ...
    switch(identifyMethod(cmd))
    {
        case UDPECHOCLIENTHELPER:
        {
            ...
            switch(nrhs)
            {
                case 2:
                {
                    ...
                    UdpEchoClientHelper *obj = new UdpEchoClientHelper(arg2);
                    MemMngmt *tst = bindMngrNewElem();
                    tst->vptr = reinterpret_cast<void*>(obj);
                    tst->objType = UDPECHOCLIENTHELPOBJ;
                ...
                case 3:
                {
                    ...
                    UdpEchoClientHelper *obj = new UdpEchoClientHelper(arg2, arg3);
                    MemMngmt *tst = bindMngrNewElem();
                    tst->vptr = reinterpret_cast<void*>(obj);
                    tst->objType = UDPECHOCLIENTHELPOBJ;
                    plhs[0] = mxCreateNumericMatrix(1, 1, mxUINT64_CLASS, mxREAL);
        ...
        case SETATTRIBUTE:
        {
            ...
            (reinterpret_cast<UdpEchoClientHelper*>(obj))->SetAttribute(arg2, arg3);
            break;
        }
        case INSTALL:
        {
            ...
            switch(nrhs)
            {
                case 3:
                {
                    ...
                    ApplicationContainer *tmp = new ApplicationContainer((reinterpret_cast<UdpEchoClientHelper*>(obj))->Install(arg2));
#else
                    ApplicationContainer *tmp;
                    if (tst2->objType == NODECONTOBJ)
                    {
                        NodeContainer arg2 = *(reinterpret_cast<NodeContainer*>(tst2->vptr));
                        tmp = new ApplicationContainer((reinterpret_cast<UdpEchoClientHelper*>(obj))->Install(arg2));
                    }
        ...
        case DELETE:
        {
            ...
            if (obj)
            {
                if (obj->objType == UDPECHOCLIENTHELPOBJ)
                    delete reinterpret_cast<UdpEchoClientHelper*>(obj->vptr);
