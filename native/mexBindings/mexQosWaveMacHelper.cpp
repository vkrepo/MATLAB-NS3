...
void mexFunction(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
    ...
    switch(identifyMethod(cmd))
    {
        ...
        case SETTYPE:
        {
            ...
            (reinterpret_cast<QosWaveMacHelper*>(obj))->SetType(arg2, arg3, arg4, arg5, arg6, arg7, arg8, arg9, arg10, arg11, arg12, arg13, arg14, arg15, arg16, arg17, arg18, arg19, arg20, arg21, arg22, arg23, arg24);
            break;
        }
        case DELETE:
        {
            ...
            if (obj)
            {
                if (obj->objType == QOSWAVEMACHELPOBJ)
                    delete reinterpret_cast<QosWaveMacHelper*>(obj->vptr);
        ...
        case DEFAULT:
        {
            ...
            QosWaveMacHelper *tmp = new QosWaveMacHelper(QosWaveMacHelper::Default());
            MemMngmt *tst = bindMngrNewElem();
