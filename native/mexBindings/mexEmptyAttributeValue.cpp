...
void* getElem(MemMngmt *obj)
{
    if (obj->objType >= SMART_PTR_ENUM_START)
        return (void*)PeekPointer(*(reinterpret_cast<Ptr<EmptyAttributeValue>*>(obj->vptr)));
    else
        return obj->vptr;
}
...
void mexFunction(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[])
{
    ...
    switch(identifyMethod(cmd))
    {
        case EMPTYATTRIBUTEVALUE:
        {
            ...
            EmptyAttributeValue *obj = new EmptyAttributeValue();
            MemMngmt *tst = bindMngrNewElem();
            tst->vptr = reinterpret_cast<void*>(obj);
            tst->objType = EMPATTRVALOBJ;
        ...
        case DELETE:
        {
            ...
            if (obj)
            {
                if (obj->objType == EMPATTRVALOBJ)
                    delete reinterpret_cast<EmptyAttributeValue*>(obj->vptr);
                else
                    delete reinterpret_cast<Ptr<EmptyAttributeValue>*>(obj->vptr);
