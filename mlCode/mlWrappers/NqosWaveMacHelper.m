classdef NqosWaveMacHelper < MlWrapper & WifiMacHelper
    % NqosWaveMacHelper This object models the functionality of a non-QoS WAVE MAC.
    % More details at: https://www.nsnam.org/docs/release/3.26/doxygen/classns3_1_1_nqos_wave_mac_helper.html
    ...
    methods
        ...
        function delete(obj)
            mexNqosWaveMacHelper('delete', obj.cppHandle);
        end
        
        function obj = NqosWaveMacHelper(varargin)
            switch (length(varargin))
                case 0
                    obj.cppHandle = mexNqosWaveMacHelper('new');
                otherwise
                    obj.cppHandle = 0;
            end
        end
